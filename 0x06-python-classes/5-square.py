...
and access/update via getter and setter methods, and printing the square."""


class Square:
    """Class Square with private instance attribute size, size validation,
    area calculation, and access/update via getter and setter methods, and printing the square."""
